...
header('location:index.php');
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO product(nama_produk,id_kategori,deskripsi_produk,stok_produk,harga_produk,gambar_produk) VALUES(:namaproduk,:kategori,:deskripsi,:stok,:harga,:gambar)";
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga" class="form-control" placeholder="Masukan harga produk. ex 100000" required>
                    </div>
                    <div class="form-group">
                        <label for="">Stok</label>
                        <input type="text" name="stok" class="form-control" placeholder="Masukan stok produk" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php $ret="select id,Namakategori from kategori";
