...
header('location:index.php');
    ...
    if(isset($_GET['del'])){
        $id=$_GET['del'];
        $sql = "delete from product_sold  WHERE id=:id";
                ...
                <thead>
                  ...
                  <?php 
                    function rupiah($angka){
                        ...
                        $sql = "select product_sold.id,product_sold.id_customer,product_sold.nama_produk,product_sold.qty,product_sold.harga,product_sold.total,product_sold.date,users.NamaLengkap from product_sold join users on product_sold.id_customer=users.id";
                        $query = $dbh -> prepare($sql);
                        $query->execute();
