...
header('location:index.php');
    ...
    if(isset($_POST['submit'])){
        ...
        $id=$_GET['id'];
        $sql="update kategori set Namakategori=:kategori where id=:id";
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card-header">
            <h3 class="card-title">Change Password Admin</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                        <div class="form-group">
                            <?php	
                                $id=$_GET['id'];
                                $ret="select * from kategori where id=:id";
                            ...
                            <input type="text" name="kategori" class="form-control" value="<?php echo htmlentities($result->Namakategori);?>" required>
                            <?php }} ?>
                        </div>
                        <div class="form-group">
